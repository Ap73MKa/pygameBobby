...
class Trigger(Sprite):
    def __init__(self, pos: tuple[int, int], groups: list[Group]):
        ...
        self.sprites = SpriteSheet(PathManager.get('assets/graphics/objects/trigger.png'), (16, 16))
        self.sprites = [scale(sprite, (sprite.get_size()[0] * 3, sprite.get_size()[1] * 3)) for sprite in
                        self.sprites[0]]
        self.frame = 0
        self.frame_speed = 35
