...
class Menu(BaseState):
    def __init__(self):
        ...
        self.active_index = 0
        self.options = ["New game", f'Choose level <{self.level_index}>', "Credit", "Quit"]
        self.next_state = GameStage.GAMEPLAY

    def render_text(self, index, custom_color=None):
        color = (
            Color((255, 255, 255)) if index == self.active_index else Color((100, 100, 100))
        )
        return self.font.render(self.options[index], True, custom_color if custom_color else color)
    ...
    def render(self):
        ...
        self.surface.blit(self.font.render('Bobby Carrot', True, (0, 0, 0)), (240 + 3, 180 + 3))
        self.surface.blit(self.font.render('Bobby Carrot', True, (255, 255, 255)), (240, 180))
